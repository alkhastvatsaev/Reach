# Reach - Project Architecture

## Overview

Reach is a high-performance outbound automation platform designed for B2B acquisition. It automates the entire funnel: from finding new leads to sending personalized, AI-generated outreach campaigns.
...
- **Search & Discovery**: Apollo.io API (Professional Lead Discovery)
- **AI Orchestration**: xAI Grok 4.20 (Multi-Agent Architecture)

## Key Modules

### 1. B2B Discovery Layer (`/api/scrape`)

- **Service**: Apollo.io
- **Logic**: Uses Apollo's High-Performance Search to find qualified leads based on keywords and location.
- **Strict Mode**: Only returns results from professional APIs to ensure 100% accuracy and formatting.
...
- **Service**: Resend
- **Feature**: Sends e-mails via the Resend SDK with campaign tracking.
